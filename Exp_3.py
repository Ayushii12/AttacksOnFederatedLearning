...
def create_poison_images(target_instance, base_instances, base_class, no_of_poisonous_images):
...
##################################################################################################################################################################
def train_model_on_poisonous_images(client_images, client_labels, poison, poison_labels, no_of_malicious_clients, no_of_poisonous_images):
 ...
 for i in range(5):
  ...
  for idx in idxs_users:
    ...
    classifier.fit(adv_train, adv_labels, nb_epochs=20, batch_size=64)
...
no_of_poisonous_images = np.array([50, 55, 60, 65, 70])
...
for i in range(5):
  for j in range(1):
    ...
    # Generating poisons
    poison, poison_labels  = create_poison_images(target_instance, base_instances, base_class, no_of_poisonous_images[i])
    ...
    defected_model = train_model_on_poisonous_images(client_images, client_labels, poison, poison_labels, no_of_malicious_clients, no_of_poisonous_images[i])
